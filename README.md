...
Abstract algebra is really cool.
Right now, I have implemented group- and ring-like structures.
...
The original goal was to provide abstractions for my [crypto](https://github.com/oliveryasuna/math) library, but never did so.
